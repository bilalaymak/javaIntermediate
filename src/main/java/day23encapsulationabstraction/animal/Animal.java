package day23encapsulationabstraction.animal;

public abstract class Animal {

  /*
        1) Sometimes we do not need method body, that is why we should not type it.
           If we do not type the "body part" the method will be "method without body”
           it means it is "abstract method"
        ...
        4) When you create an "Abstract method" in parent class,
           the functionality will be mandatory for the child classes.
        ...
        6)To make a method abstract
            ...
            iii)Change the "concrete class" to "abstract class"
            by using abstract keyword between "access modifier" and "class" keyword
            Note: After creating an abstract method do not forget to use the method
            in all "concrete" child classes.
