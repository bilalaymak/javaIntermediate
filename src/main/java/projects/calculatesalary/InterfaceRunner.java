 ...
 /*
   ...
   */
    ...
    public static void main(String[] args) {
        ...
        CalculateSalary marksSalary = new CalculateSalary();
        System.out.println(marksSalary.netSalary(8000, 5, 200));

        System.out.println("==============");

        CalculateSalary marysSalary = new CalculateSalary();
        System.out.println(marksSalary.netSalary(15000, 15, 150));
