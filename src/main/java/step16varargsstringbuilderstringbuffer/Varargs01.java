package step16varargsstringbuilderstringbuffer;
...
public class Varargs01 {
  ...
  /*
        ...
        you may think you are using "Arrays"
        3)Question: Can I use more than one "Varargs" in a method?
                    No I can't. Varargs cannot be made full, that is why Java cannot jump to the second parameter
                    so second parameter will be "unreachable",
