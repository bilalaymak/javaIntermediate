...
public interface Ac {
    ...
    //Variables are "final" in an interface as default,
    // that is why when you create a variable you have to initialize.
    //Variables are "public" in an interface as default,
    // that is why when you create a variable no need to declare it as "public".
    //Variables are "static" in an interface as default,
    // that is why when you try to access to a variable no need to create an object use just interface name.
    int price = 2000;

    //Note: An interface may have "public" or "default" access modifier,
    // you cannot use "protected" and "private" access modifiers same in "Classes"
