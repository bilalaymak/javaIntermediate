package step21encapsulationabstraction.student;
...
public class Student{
    ...
    encapsulation is getter and setter
        ...
        3)In getters;
            ...
            iii)"Method Name" should have "get + <Variable Name>" structure
                Note: If the data type of the variable is "boolean",
                make the "Method Name" structure like "is + <Variable Name>"
    ...
    public boolean isSuccess() {//in boolean getter name is "isSuccess"
        return success;
    }
