...
public class E01 {
  ...
  /*
        ...
        2)"throw" can be used multiple times in a method body,
          "throws" can be used just once in the method signature line
        ...
        1)Java created its own Exception Classes for common issues like dividing by zero,
          using non-existing indexes etc.
