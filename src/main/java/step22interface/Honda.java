...
public class Honda implements Ac, Engine{
    ...
    /*
        ...
        6)Interfaces are "fully abstract", I mean "Interfaces" cannot have concrete methods,
        all methods in an interface must be abstract method.
        As you know "abstract methods" must be implemented by "concrete child classes",
        ...
        8)Methods in an interface are "public" and "abstract",
        that is why no need to type "public" and "abstract" when you create a method
        ...
        10)Do not make an "abstract method" "static" because,
        "static" methods cannot be overridden but "abstract methods" are created to override.
