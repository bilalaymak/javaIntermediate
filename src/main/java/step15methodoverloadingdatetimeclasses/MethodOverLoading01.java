package step15methodoverloadingdatetimeclasses;

public class MethodOverLoading01 {
     /*
        1)If you create methods with
        i)the same name and ii)different parameters, it means you created "method overloading"
